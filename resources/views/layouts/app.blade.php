        ...
        @else
            ...
            <aside class="app-sidebar">
                ...
                <ul class="app-menu">
                    ...
                    <li class="treeview {{ Route::current()->getName()=='show_report'|| Route::current()->getName()=='changerent_report'|| Route::current()->getName()=='ruser_report'|| Route::current()->getName()=='agentsshow_report'||Route::current()->getName()=='pagent_report'||Route::current()->getName()=='paidsearch_report'||Route::current()->getName()=='savepaid_report'|| Route::current()->getName()=='usershow_report'?'is-expanded':''}} "><a  data-toggle="treeview" class="app-menu__item {{ Route::current()->getName()=='show_report'?'active':''}} " href="{{ route('show_report') }}"><i class="app-menu__icon fa fa-address-card-o"></i><span class="app-menu__label">Reports</span></a>
                        <ul class="treeview-menu">
                            ...
                            <li><a class="treeview-item {{ Route::current()->getName()=='usershow_report'|| Route::current()->getName()=='ruser_report'|| Route::current()->getName()=='changerent_report'?'active':''}}" href="{{route('usershow_report')}}"><i class="icon fa fa-circle-o"></i> User report</a></li>
                        </ul>
                    </li>
